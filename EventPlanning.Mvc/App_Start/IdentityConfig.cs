...
namespace EventPlanning.Mvc
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var client = new SmtpClient(GmailSmtpSendAdress, GmailSmtpSendPort)
            {
                DeliveryMethod = SmtpDeliveryMethod.Network,
                UseDefaultCredentials = false,
                Credentials = new System.Net.NetworkCredential(SenderEmail, SenderPasswordEmail),
                EnableSsl = true
            };

            var mail = new MailMessage(SenderEmail, message.Destination)
            {
